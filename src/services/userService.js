        ...
        try {
            ...
            if (isExit) { // nếu hàm trả về true 
                ...
                if (check) {
                    ...
                    userData.errCode = 0;
                    delete user.password; // dòng truy vấn sql bên trên lấy ra password , dòng này hủy pass, ko cho truyền password về phía frontenđ = response
                    userData.user = user;
                    
                    console.log('OK');
                } else {
                    userData.errMessage = 'Lỗi pass rồi . email thì có mà pas thì ko trùng khớp với pass cũ ';
                    userData.errCode = 2;
                }
